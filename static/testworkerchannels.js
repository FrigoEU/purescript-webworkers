...
(function(exports) {
  ...
  var parseJSON = function ($0) {
      return Control_Monad_Except_Trans.ExceptT(Data_Identity.Identity(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(function ($1) {
          return Control_Applicative.pure(Data_List_Types.applicativeNonEmptyList)(Data_Foreign.JSONError.create(Effect_Exception.message($1)));
      })(Effect.runPure(Effect_Exception["try"](Effect_Uncurried.runEffectFn1($foreign.parseJSONImpl)($0))))));
  };
...
(function(exports) {
  ...
  var pureST = function (f) {
      return Effect.runPure($foreign.runST(f));
  };
  ...
  var insert = function (k) {
      return function (v) {
          return mutate(function (s) {
              return Data_Functor["void"](Effect.functorEffect)(Data_StrMap_ST.poke(s)(k)(v));
          });
      };
  };
  exports["insert"] = insert;
          ...
          return function (handle) {
              return Data_StrMap.insert(v.name)(function (str) {
                  return Data_Either.either(function (v1) {
                      return Effect_Console.log("Failed to decode string for channel " + v.name);
                  })(handle)(v.decode(str));
              })(chs);
          };
      };
  ...
  var handleMessageWithChannels = function (chs) {
      return function (v) {
          var handleMess = function (v1) {
              return Data_Either.either(Effect_Console.log)(Control_Category.id(Control_Category.categoryFn))(Control_Bind.bind(Data_Either.bindEither)(Data_Maybe.maybe(Data_Either.Left.create("Couldn't find handler for channel " + v1.t))(Data_Either.Right.create)(Data_StrMap.lookup(v1.t)(chs)))(function (v2) {
