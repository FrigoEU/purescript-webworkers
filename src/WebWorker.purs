...
onmessageC :: forall eff1 eff2. Channels (console :: CONSOLE | eff1) -> Eff (isww :: IsWW | eff2) Unit
onmessageC chs = onmessage (handleMessageWithChannels chs)

onmessageFromWorkerC :: forall eff1 eff2. WebWorker -> Channels (console :: CONSOLE| eff1) -> Eff (ownsww :: OwnsWW | eff2) Unit
